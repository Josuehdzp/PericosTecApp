...
public class MensajeriaActivityAlimentarias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setImagePickerCallback(new ImagePickerCallback() {
            ...
            public void onError(String s) {
                Toast.makeText(MensajeriaActivityAlimentarias.this, "Error: " + s, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fotoPerfil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(MensajeriaActivityAlimentarias.this);
                ...
                if (mapUsuariosTemporales.get(mensaje.getKeyEmisor()) != null) {
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(MensajeriaActivityAlimentarias.this, "Error: " + error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            ...
            CafeBar.builder(MensajeriaActivityAlimentarias.this)
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (CARRERITAS.equals("IIAL")) {
                        ...
                        carreraEstado.setText(R.string.titulo_alimentarias);
                    } else {
...
*/
    ...
    private void returnLogin() {
        startActivity(new Intent(MensajeriaActivityAlimentarias.this, LoginActivity.class));
        finish();
    }
