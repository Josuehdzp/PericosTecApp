...
public class MensajeriaActivityGestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setImagePickerCallback(new ImagePickerCallback() {
            ...
            public void onError(String s) {
                Toast.makeText(MensajeriaActivityGestion.this, "Error: " + s, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fotoPerfil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(MensajeriaActivityGestion.this);
                ...
                if (mapUsuariosTemporales.get(mensaje.getKeyEmisor()) != null) {
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(MensajeriaActivityGestion.this, "Error: " + error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            ...
            CafeBar.builder(MensajeriaActivityGestion.this)
...
*/
    ...
    private void returnLogin() {
        startActivity(new Intent(MensajeriaActivityGestion.this, LoginActivity.class));
        finish();
    }
