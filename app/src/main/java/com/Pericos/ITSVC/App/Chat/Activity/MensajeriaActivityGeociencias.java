...
public class MensajeriaActivityGeociencias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setImagePickerCallback(new ImagePickerCallback() {
            ...
            public void onError(String s) {
                Toast.makeText(MensajeriaActivityGeociencias.this, "Error: " + s, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fotoPerfil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(MensajeriaActivityGeociencias.this);
                ...
                if (mapUsuariosTemporales.get(mensaje.getKeyEmisor()) != null) {
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(MensajeriaActivityGeociencias.this, "Error: " + error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            ...
            CafeBar.builder(MensajeriaActivityGeociencias.this)
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (CARRERITAS.equals("IGEO")) {
                        ...
                        carreraEstado.setText(R.string.titulo_geociencias);
                    } else {
...
*/
    ...
    private void returnLogin() {
        startActivity(new Intent(MensajeriaActivityGeociencias.this, LoginActivity.class));
        finish();
    }
